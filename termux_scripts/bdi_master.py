...
# --- GANTI SELURUH CLASS INI DENGAN VERSI YANG BENAR ---
...
class IntentionSystem:
    ...
    async def _execute_single_intention(self, intention: Dict):
        if intention['action'] == 'trigger_github_workflow':
            await self._trigger_github_workflow(intention['workflow'], intention['parameters'])
    ...
    # --- INI FUNGSI YANG KITA PINDAHKAN KE DALAM ---
...
class FMAABDIMaster:
    ...
    def _load_config(self):
        if os.getenv("VERCEL") == "true":
            ...
            print("✅ Running locally, using environment variables from .env.")
    ...
    def start_dashboard(self):
        print("🌐 Starting dashboard at http://localhost:8081")
